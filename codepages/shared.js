...
const CONFIG = {
    ...
    fields: {
        orders: {
            ...
            contractContactFirst: 48, contractContactLast: 49, contractEmail: 50, contractPhone: 51,
            ycrmOpportunityId: 39, concessionsApproval: 42, concessionsApprovedBy: 43, concessionsApprovedDate: 44,
            relatedQuote3D: 47
        },
        orderLineItems: {
